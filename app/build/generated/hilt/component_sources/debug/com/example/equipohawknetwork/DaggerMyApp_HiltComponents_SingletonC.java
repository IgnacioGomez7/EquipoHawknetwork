...
import com.example.equipohawknetwork.model.EventViewModel_HiltModules;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    @Override
    public void injectEventsActivity(EventsActivity arg0) {
    }
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_example_equipohawknetwork_model_EventViewModel, EventViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_equipohawknetwork_model_EventViewModel = "com.example.equipohawknetwork.model.EventViewModel";

      @KeepFieldType
      EventViewModel com_example_equipohawknetwork_model_EventViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_example_equipohawknetwork_model_EventViewModel, ((Provider) eventViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.equipohawknetwork.model.EventViewModel 
